    ...
    <div class="<?php print $options['content_class'];?>">
        ...
        <?php while (have_posts()) : the_post(); ?>
            ...
            <div class="contact-wrapper">    
                <div class="col-lg-8 col-md-8 col-sm-8 col-lg-offset-2 col-md-offset-2 col-sm-offset-2 contact_page_company_details">  

                    <?php echo do_shortcode("[contact-form-7 id='2066' title='Contact']"); ?>
                    ...
                    <!-- <div class="agent_contanct_form">
                        ...
                        <input type="submit" class="wpb_btn-info wpb_btn-small wpestate_vc_button  vc_button"  id="agent_submit_contact" value="<?php esc_html_e('SEND', 'wpestate'); ?>">
                ...
                <div class="col-lg-8 col-md-8 col-sm-8 col-lg-offset-2 col-md-offset-2 col-sm-offset-2 contact_page_company_picture">
