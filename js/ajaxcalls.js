...
function wpestate_register() {
    "use strict";
    var user_pass,user_pass_retype,capthca,user_login_register, user_email_register, user_first_name_register, user_last_name_register, user_phone_register, nonce, ajaxurl,propid, user_type;
    ...
    user_first_name_register    =   jQuery('#user_first_name_register').val();
    user_last_name_register    =   jQuery('#user_last_name_register').val();
    user_phone_register    =   jQuery('#user_phone_register').val();

    console.log('user_first_name_register: ' + user_first_name_register);
    // console.log('user_phone_register: ' + user_phone_register);
    ...
    jQuery.ajax({
        ...
        data: {
            ...
            'user_login_register'       :   user_login_register,
            'user_email_register'       :   user_email_register,
            'user_first_name_register'  :   user_first_name_register,
            'user_last_name_register'   :   user_last_name_register,
