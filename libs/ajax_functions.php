...
if( !function_exists('wpestate_ajax_register_form') ):
    ...
    function wpestate_ajax_register_form(){
        ...
        $allowed_html       =   array();
        $user_first_name    =   trim( wp_kses ($_POST['user_first_name_register'],$allowed_html ));
        $user_last_name     =   trim( wp_kses ($_POST['user_last_name_register'],$allowed_html ));
        $user_phone         =   trim( wp_kses ($_POST['user_phone_register'],$allowed_html ));
                ...
                <div class="modal fade" id="loginmodal" tabindex="-1" aria-labelledby="myModalLabel" aria-hidden="true">
                  <div class="modal-dialog">
                    <div class="modal-content">
                      <div class="modal-header"> 
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                        <h2 class="modal-title_big" >'.esc_html__( 'Login / Signup').'</h4>
                      </div>
