...
function wpestate_register_form_function($attributes, $content = null) {
    ...
    $return_string='
        <div class="login_form shortcode-login">
                ...
                <div class="loginrow">
                    <input type="text" name="user_first_name_register" id="user_first_name_register'.$type.'" class="form-control" placeholder="'.esc_html__( 'First Name','wpestate').'" size="20" />
                </div>
                <div class="loginrow">
                    <input type="text" name="user_last_name_register" id="user_last_name_register'.$type.'" class="form-control" placeholder="'.esc_html__( 'Last Name','wpestate').'" size="20" />
                </div>
                <div class="loginrow">
                    <input type="text" name="user_phone_register" id="user_phone_register'.$type.'" class="form-control" placeholder="'.esc_html__( 'Phone Number','wpestate').'" size="20" />
                </div>
                <div class="loginrow">
